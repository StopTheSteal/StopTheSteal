...
generate.precinct.csv2 <- function(base_dir, sid, state_abbr, file_prefix, file_postfixes)
{
  ...
  #   bidenj	148
  #   other	1
  #vote_type	"electionday"
  #geo_id	"37183-PCT 01-13"
  #precinct_name	""
  #locality_fips	"37183"
  #is_geographic	true
  #votes	254
  ...
  #precinct_id	"City of St. Joseph Precinct 1"
  #vote_type	"total"
  #results	
  #   bidenj	1028
  #   trumpd	771
  ...
  #
  # GA
  #precinct_id	"Nashville"
  #locality_name	"Berrien"
  #is_reporting	true
  #results	
  #   trumpd	2444
  #   bidenj	361
